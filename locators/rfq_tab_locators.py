...
rfq_acc_name = (By.XPATH, '//input[@placeholder="Search Account"]')
rfq_key_contact_person = (By.XPATH, '//input[@placeholder="Search Key Contact Person"]')
select_key_contact_peroson = (By.XPATH, '(//input[@placeholder="Search Key Contact Person"]/..//li)[1]')
