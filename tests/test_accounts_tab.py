...
def create_norms(browser):
    ...
    norms_steps.select_over_head_norms(browser, 'MAPL B-03 Waluj') #rfq_steps.manufacturing_location)
    # norms_steps.select_currency_norms(browser)
    # norms_steps.select_mhr_norms(browser, 'MAPL B-03 Waluj') #rfq_steps.manufacturing_location)
    pdb_apply()
